      ...
      (wp.ajax = {
        ...
        send: function (n, t) {
          ...
          return (
            _.isObject(n)
              ? (t = n)
              : ((t = t || {}).data = _.extend(t.data || {}, { action: n })),
            (t = _.defaults(t || {}, {
              type: "POST",
                      ...
                      _.isObject(t) && !_.isUndefined(t.success)
                        ? ((e = this),
                          a.done(function () {
                            n &&
                            n.data &&
                            "query-attachments" === n.data.action &&
                            a.jqXHR.hasOwnProperty("getResponseHeader") &&
                            a.jqXHR.getResponseHeader("X-WP-Total")
                          ...
                          a[t.success ? "resolveWith" : "rejectWith"](this, [
                            t.data,
                          ]))
                        : a.rejectWith(this, [t]);
                  })
