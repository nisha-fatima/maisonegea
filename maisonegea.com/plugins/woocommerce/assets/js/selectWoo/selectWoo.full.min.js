...
!(function (n) {
            ...
            (n.prototype.reset = function () {
              ...
              this.defaults = {
                ...
                matcher: function a(e, t) {
                  if (null == e.term || "" === e.term.toString().trim())
                    return t;
        ...
        function (e, s) {
          ...
          return (
            (t.prototype.render = function (e) {
              ...
              return (
                "function" == typeof e && (e = e(this.$element)),
  ...
  function l(e, t) {
    var n,
      ...
      u,
      d,
      p = t && t.split("../index.html"),
      h = y.map,
      f = (h && h["*"]) || {};
    if (e) {
      for (
        t = (e = e.split("../index.html")).length - 1,
    ...
    if ((p || f) && h) {
      for (c = (n = e.split("../index.html")).length; 0 < c; --c) {
        if (((i = n.slice(0, c).join("../index.html")), p))
          for (u = p.length; 0 < u; --u)
            if ((o = (o = h[p.slice(0, u).join("../index.html")]) && o[i])) {
              (s = o), (r = c);
              break;
            }
        if (s) break;
      ...
      !s && a && ((s = a), (r = l)),
        s && (n.splice(0, r, s), (e = n.join("../index.html")));
    }
    return e;
  }
  function b(t, n) {
