!(function (t) {
        ...
        .then(function () {
          t(document).on(
            ...
            t(document.body).on(
              ...
              ".composite_data",
              function (i, e) {
                e.actions.add_action(
                  "component_options_state_changed",
                  function (i) {
                    t(i.$component_content)
                      .find(".variations_form")
                      .removeClass("wvs-loaded wvs-pro-loaded");
                  }
                );
              }
            ),
            ...
            t(document).on(
              "berocket_ajax_products_loaded.wvs berocket_ajax_products_infinite_loaded.wvs",
              function () {
                t(".variations_form:not(.wvs-loaded)").each(function () {
                  t(this).wc_variation_form();
                });
            ...
            t(".shop-container .products, .infinite-scroll-wrap").on(
            ...
            t(document).on(
              "nm_infload_after.wvs nm_ajax_shop_update_content.wvs",
              function () {
                t(".variations_form:not(.wvs-loaded)").each(function () {
                  t(this).wc_variation_form();
                });
  ...
  11: function (t, i, e) {
    ...
    var o = (function (t) {
        ...
        e = (function () {
          function e(a, o) {
            !(function (t, i) {
              ...
              (this.is_mobile = t("body").hasClass(
                "woo-variation-swatches-on-mobile"
              )),
              ...
              [
                {
                  ...
                  value: function () {
                    var i = this,
                      e = this;
                    (this._generated = this.product_variations.reduce(function (
                      t,
                      i
                    ) {
                      return (
                        Object.keys(i.attributes).map(function (e) {
                          t[e] || (t[e] = []),
                    ...
                    {})),
                      (this._out_of_stock = this.product_variations.reduce(
                        function (t, i) {
                          return (
                            Object.keys(i.attributes).map(function (e) {
                              t[e] || (t[e] = []),
                      ...
                      this.$element
                        ...
                        .each(function (i, a) {
                          t(this)
                            .parent()
                            .addClass("woo-variation-items-wrapper");
                          var o = t(this).siblings(
                          ...
                          s.length < 1 &&
                            ((s = (o = t(this)
                              .parent()
                              .find("select.woo-variation-raw-select")).find(
                              "option"
                            )),
                            (r = o.find("option:disabled")),
                            (c = o.find("option.enabled.out-of-stock")),
                          ...
                          h.each(function (i, e) {
                            ...
                            t(this)
                              .removeClass("selected disabled out-of-stock")
                              .addClass("disabled"),
                              t(this).attr("aria-checked", "false"),
                              t(this).attr("tabindex", "-1"),
                              t(this).hasClass("radio-variable-item") &&
                                t(this)
                                  .find("input.wvs-radio-variable-item:radio")
                                  .prop("disabled", !0)
                                  .prop("checked", !1),
                              _.includes(w, a) &&
                                ...
                                a === n &&
                                  ...
                                  t(this).hasClass("radio-variable-item") &&
                                    t(this)
                                      .find(
                                        "input.wvs-radio-variable-item:radio"
                                      )
                                      .prop("checked", !0))),
                              g.length > 0 &&
                                _.includes(p, a) &&
                            ...
                            v
                              ? (t(this).on(
                                  "click.wvs",
                                  "li:not(.selected):not(.radio-variable-item):not(.woo-variation-swatches-variable-item-more)",
                                  function (i) {
                                    ...
                                    o.val(a).trigger("change"),
                                      ...
                                      t(this).trigger("wvs-selected-item", [
                                        a,
                                        o,
                                        e.$element,
                                      ]);
                                ...
                                t(this).on(
                                  "click.wvs",
                                  "li.selected:not(.radio-variable-item):not(.woo-variation-swatches-variable-item-more)",
                                  function (i) {
                                    i.preventDefault(), i.stopPropagation();
                                    var a = t(this).val();
                                    o.val("").trigger("change"),
                                      ...
                                      e.is_mobile && o.trigger("touchstart"),
                                      t(this).trigger("focus"),
                                      t(this).trigger("wvs-unselected-item", [
                                        a,
                                        o,
                                        e.$element,
                                      ]);
                              ...
                              : (t(this).on(
                                  "click.wvs",
                                  "li:not(.radio-variable-item):not(.woo-variation-swatches-variable-item-more)",
                                  function (i) {
                                    i.preventDefault(), i.stopPropagation();
                                    var a = t(this).data("value");
                                    o.val(a).trigger("change"),
                            ...
                            t(this).on(
                              "keydown.wvs",
                              "li:not(.disabled):not(.woo-variation-swatches-variable-item-more)",
                              function (i) {
                                ((i.keyCode && 32 === i.keyCode) ||
                                  (i.key && " " === i.key) ||
                                  (i.keyCode && 13 === i.keyCode) ||
                                  (i.key && "enter" === i.key.toLowerCase())) &&
                                  (i.preventDefault(),
                                  t(this).trigger("click.wvs"));
                              }
                            );
                        }),
                      this.$element.trigger("woo_variation_swatches_init", [
                        this,
                        this.product_variations,
                      ]),
                      t(document).trigger("woo_variation_swatches_loaded", [
                        this.$element,
                        this.product_variations,
                      ]);
                  },
                            ...
                            .each(function (e, a) {
                              ...
                              i.is_ajax_variation
                                      ...
                                      o === n &&
                                        ...
                                        t(this).hasClass(
                                          ...
                                          t(this)
                                            ...
                                            .prop("disabled", !1)
                                            .prop("checked", !0)),
                                      t(this).trigger("wvs-item-updated", [
                                        n,
                                        o,
                                        i,
                                      ]);
                                ...
                                : h.each(function (e, a) {
                                    ...
                                    t(this)
                                      .removeClass(
                                        "selected disabled out-of-stock"
                                      )
                                      .addClass("disabled"),
                                      t(this).attr("aria-checked", "false"),
                                      t(this).attr("tabindex", "-1"),
      ...
      return (
        (t.fn.WooVariationSwatches = e._jQueryInterface),
        (t.fn.WooVariationSwatches.Constructor = e),
        (t.fn.WooVariationSwatches.noConflict = function () {
          return (
            (t.fn.WooVariationSwatches = t.fn.WooVariationSwatches),
            e._jQueryInterface
          );
        }),
        e
